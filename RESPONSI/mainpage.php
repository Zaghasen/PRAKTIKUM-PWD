...
<body>
    <nav class="navbar navbar-expand-lg navbar-custom">
        <div class="container-fluid mx-5">
            ...
            <a href="login.php" type="button" class="btn btn-warning">LOGIN</a>
    ...
    <div class="container ">
        ...
        <div class=" d-flex justify-content-center align-items-center vh-100">
            <div class=" m-auto" style="width: 500px;">
                ...
                <p class="text-white">[Halaman ini hanya bisa diakses oleh admin]</p>
            ...
            <div class="">
                <img src="img/2.jpg" alt="gambar" class="p-0 m-0">
            </div>
        </div>
